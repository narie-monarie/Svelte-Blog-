...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="svelte-scea26">
	<a href="/" class="title svelte-scea26"><b>${escape(title)}</b></a>

	
	<ul class="links svelte-scea26"><li><a href="/about" class="svelte-scea26">About</a></li>
		<li><a href="/contact" class="svelte-scea26">Contact</a></li></ul>
	${validate_component(Toggle, "Toggle").$$render($$result, {}, {}, {})}
</nav>`;
});
const footer_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: "footer.svelte-1a82mgg{padding-block:var(--size-7);border-top:1px solid var(--border)}p.svelte-1a82mgg{color:var(--text-2)}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<footer class="svelte-1a82mgg"><p class="svelte-1a82mgg">${escape(title)} © ${escape((/* @__PURE__ */ new Date()).getFullYear())}</p>
</footer>`;
});
const openProps_min = "";
const normalize_min = "";
...
const css = {
  code: ".layout.svelte-plfzno{height:100%;max-inline-size:1440px;display:grid;grid-template-rows:auto 1fr auto;margin-inline:auto;padding-inline:var(--size-7)}main.svelte-plfzno{padding-block:var(--size-9)}@media(min-width: 1440px){.layout.svelte-plfzno{padding-inline:0}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="layout svelte-plfzno">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
	<main class="svelte-plfzno">${slots.default ? slots.default({}) : ``}</main>
